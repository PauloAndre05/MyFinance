...
export const ModalCriarTransacao = ({ isOpen, setIsOpen }: ModalCriarTransacaoProps) => {
  ...
  return (
    <>
      {isOpen && (
        <div className="absolute bg-black/10 inset-0 flex justify-center items-center backdrop-blur-[.5px] z-10" onClick={handleCloseModal}>
          <div className="p-6 bg-white dark:bg-secondary mx-auto shadow-md flex flex-col gap-6 rounded-md z-50"  onClick={(e) => e.stopPropagation()}>
